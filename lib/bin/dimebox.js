...
let _       = require('underscore'),
   ...
   watch    = require('../watch'),
   kill    = require('../kill'),
   ping    = require('../xyz/ping'),
   push    = require('../xyz/push'),
...
let argv = require('yargs')
  ...
  .command('xyz-ping', 'Test dimebox.xyz config.')
  .command('xyz-push [epoch]', 'Push experiments to dimebox.xyz.')
...
const handler = {
  routes: {
    ...
    "xyz-ping": () => ping(),
    "xyz-push": () => push(argv.epoch),
  },
  guarded: ["generate", "summary", "submit", "parse", "rm", "resolve", "watch", "kill", "xyz-ping", "xyz-push"]
}
